...
if __name__ == "__main__":
    ...
    with open ('inputparameters.txt','w') as f: #create new file for writing input parameters
        with open("Input.txt") as file: #read input file
            ...
            for row in reader:
                ...
                system = averages , threatscore, threat_scores, number_of_threat, average, output
